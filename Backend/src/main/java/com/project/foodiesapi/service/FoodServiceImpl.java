...
public class FoodServiceImpl implements FoodService {
    ...
    public String uploadFile(MultipartFile file) {
        ...
        try {
            ...
            java.nio.file.Path filePath = uploadDir.resolve(key);
    ...
    public List<FoodResponse> readFoods() {
        ...
        return databaseEntries.stream().map(object -> convertToResponse(object)).collect(Collectors.toList()); // converted
                                                                                                               // list
                                                                                                               // of
                                                                                                               // foodEntities
                                                                                                               // to
    ...
    public FoodResponse readFood(String id) {
        FoodEntity databaseEntry = foodRepository.findById(id)
